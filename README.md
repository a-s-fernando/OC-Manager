...
| GET    | /source/:id                   | N/A                                                                                                                          | Get a specific source                                                |
...
| GET    | /race/:id                     | N/A                                                                                                                          | Get a specific race                                                  |
...
| GET    | /image/:id                    | N/A                                                                                                                          | Get a specific image                                                 |
...
| GET    | /gender/:id                   | N/A                                                                                                                          | Get a specific gender                                                |
...
| DELETE | /character/relation           | id int                                                                                                                       | Delete a specific character relation                                 |
| DELETE | /character/profile_image      | id int                                                                                                                       | Delete a particular profile image                                    |
| DELETE | /character/character_in_image | imageID int, characterID int                                                                                                 | Delete a character from a particular image                           |
| DELETE | /character/source             | sourceID int, characterID int                                                                                                | Delete a source from a particular character                          |
| DELETE | /character/like               | characterID int, name str                                                                                                    | Delete a particular like from a character                            |
| DELETE | /character/dislike            | characterID int, name str                                                                                                    | Delete a particular dislike from a character                         |
